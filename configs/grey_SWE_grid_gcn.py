...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = '/remote-home/my/hhy/Ultrasound_MIL/code_results/5folds/Grid_Graph/4'
        ...
        self.trainbag = PatientBags(self.data_root, pre_transform=self.train_transform, sub_list=[0,1,2,3],crop_list=True)
        self.testbag = PatientBags(self.data_root, pre_transform=self.test_transform, sub_list = [4], crop_list=True)
