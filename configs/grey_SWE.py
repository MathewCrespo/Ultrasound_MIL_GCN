...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = '/media/hhy/data/code_results/Debug_MIL'
        ...
        self.trainset = BMDataset(self.data_root+'/train', self.train_transform)
        self.testset = BMDataset(self.data_root+'/test', self.test_transform)

        self.trainbag = BMBags(dataset=self.trainset)
        self.testbag = BMBags(dataset=self.testset)
        ...
        self.train_loader = DataLoader(self.trainbag, batch_size=self.batch_size, shuffle=True, num_workers=8)
