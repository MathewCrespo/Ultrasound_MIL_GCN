...
from models.attentionMIL import Attention, GatedAttention, MIL, Res_Attention, H_Attention, C_Attention,Clinical
from trainers.MILCTrainer import MILCTrainer
from trainers.Ctrainer import Ctrainer
...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = '/remote-home/my/hhy/Ultrasound_MIL/experiments/clinical_base0/'
        ...
        self.resume = -1
        self.batch_size = 1
        self.net = Clinical(C=self.clinical_len)
        self.net.cuda()
        ...
        self.trainer = Ctrainer(self.net, self.optimizer, self.lrsch, None, self.train_loader, self.val_loader,
                                  self.logger,
                                  self.global_step)
