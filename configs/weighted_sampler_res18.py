...
class Config(object):
    def __init__(self):
        ...
        self.log_dir = '/remote-home/my/hhy/Ultrasound_MIL/experiments/weighted_sampler_resnet18_fold3/'
        ...
        self.trainbag = RuijinBags(self.root, [0,1,2,4],self.train_transform)
        self.testbag = RuijinBags(self.root, [3], self.test_transform)
