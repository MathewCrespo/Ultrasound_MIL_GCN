...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = '/remote-home/my/hhy/Ultrasound_MIL/code_results/5folds/Attention/0'
        ...
        self.trainbag = PatientBags(self.data_root, pre_transform=self.train_transform, sub_list=[1,2,3,4])
        self.testbag = PatientBags(self.data_root, pre_transform=self.test_transform, sub_list = [0])
